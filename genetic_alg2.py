...
def solve(maze, start_point, end_point, chromosome_length, mate_rate, mutation_rate, iterations, population):
    ...
    def fitness(chromosome):
        ...
        # a, b = 0, 0
        # if end_point[0] - actual_y < 0:
        #     a = -1
        # elif end_point[0] - actual_y > 0:
        #     a = 1
        # if end_point[1] - actual_x < 0:
        #     b = -1
        # elif end_point[1] - actual_x > 0:
        #     b = 1
        #
        # if (maze[actual_y + a][actual_x] == 1) and (maze[actual_y][actual_x + b] == 1):
        #     value = value + 100
        #
        # if end_point[0] - actual_y == 0:
        #     if maze[actual_y][actual_x + b] == 1:
        #         value = value + 100
        # if end_point[1] - actual_x == 0:
        #     if maze[actual_y][actual_x + b] == 1:
        #         value = value + 100
